...
/***/ (function(module, exports, __webpack_require__) {
	...
	var contactsEvents = __webpack_require__(12);
	...
	$(function () {
	  ...
	  authUi.hideAuthContent();
	  contactsEvents.addHandlers();
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var logEvents = __webpack_require__(37);
	var getFormFields = __webpack_require__(8);
	...
	var contextMenuResponse = function contextMenuResponse(event) {
	...
	var getContactsSuccess = function getContactsSuccess(data) {
	...
	var onGetContacts = function onGetContacts(event) {
	  event.preventDefault();
	  ui.clearContacts();
	  api.getContacts().then(getContactsSuccess).catch(ui.failure);
	};
	...
	var onSaveNewContact = function onSaveNewContact(event) {
	  event.preventDefault();
	  var contactData = getFormFields(event.target.form);
	  contactData.contact['user_id'] = store.user.id;
	  if (contactData.contact['first_name'] === '' || contactData.contact['last_name'] === '' || contactData.contact['email'] === '') {
	    $('#content-feedback').text('First Name, Last Name, and Email are all required');
	    return;
	  }
	  api.createContact(contactData).then(createContactSuccess).catch(ui.failure);
	};
	var onSaveContact = function onSaveContact(event) {
	  event.preventDefault();
	  var contactId = store.contactId;
	  var contactData = getFormFields(event.target.form);
	  if (contactData.contact['first_name'] === '' || contactData.contact['last_name'] === '' || contactData.contact['email'] === '') {
	    $('#content-feedback').text('First Name, Last Name, and Email are all required');
	    return;
	  }
	  api.updateContact(contactId, contactData).then(ui.updateContactSuccess).catch(ui.failure);
	};

	var onCancelContact = function onCancelContact(event) {
	...
	var onDeleteContact = function onDeleteContact(event) {
	  event.preventDefault();
	  var contactId = store.contactId;
	  api.deleteContact(contactId).then(ui.deleteContactSuccess).catch(ui.failure);
	};
	...
	var editContact = function editContact(event) {
	  ...
	  var contact = store.contacts.find(findContact);
	  ui.clearContacts();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createContact = function createContact(contactData) {
	  return $.ajax({
	...
	var getContact = function getContact(contactId) {
	  return $.ajax({
	...
	var updateContact = function updateContact(contactId, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/contacts/' + contactId,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showContactsTemplate = __webpack_require__(15);
	var showContactEditTemplate = __webpack_require__(35);
	var showContactNewTemplate = __webpack_require__(36);

	// const eve = require('./events-contacts.js')

	var displayContacts = function displayContacts(contacts) {
	  store.contacts = contacts;
	  var showContactsHtml = showContactsTemplate({ contacts: contacts });
	  $('#content').append(showContactsHtml);
	};

	var displayContact = function displayContact(contact) {
	  var showContactEditHtml = showContactEditTemplate({ contact: contact });
	  $('#content').append(showContactEditHtml);
	};

	var displayNewContact = function displayNewContact(contact) {
	  var showContactNewHtml = showContactNewTemplate({ contact: contact });
	...
	var deleteContactSuccess = function deleteContactSuccess(data) {
	...
	module.exports = {
	  ...
	  displayNewContact: displayNewContact,
	  failure: failure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "            <tr row-id=\""
	    ...
	    + "</td>\n                <td class=\"edit-company\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.company : stack1), depth0))
	    + "</td>\n            </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h3>Contacts:</h1>\n<!-- <script id=\"some-template\" type=\"text/x-handlebars-template\">  -->\n  <table data-toggle=\"table\" id=\"context\" data-toggle=\"context\" data-target=\"#context-menu\">\n    <thead>\n    <th>Name</th>\n    <th>Email</th>\n    <th>Position</th>\n    <th>Company</th>\n    </thead>\n    <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.contacts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      </tbody>\n    </table>\n\n    <div class=\"context\" hidden>\n      <div class=\"context_item\">\n        <div class=\"inner_item\" id=\"new\">\n          New\n        </div>\n      </div>\n      <div class=\"context_item\">\n        <div class=\"inner_item\" id=\"edit\">\n          Edit\n        </div>\n      </div>\n      <div class=\"context_item\">\n        <div class=\"inner_item\" id=\"delete\">\n          Delete\n        </div>\n      </div>\n      <div class=\"context_hr\"></div>\n      <div class=\"context_item\">\n        <div class=\"inner_item\" id=\"display-logs\">\n          Display Contact Log\n        </div>\n      </div>\n      <div class=\"context_item\">\n        <div class=\"inner_item\" id=\"email-contact\">\n          Email Contact\n        </div>\n      </div>\n    </div>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h3>Edit Contact:</h1>\n<!-- <script id=\"some-template\" type=\"text/x-handlebars-template\">  -->\n<form id=\"edit-contact\" >\n  <div class=\"row\">\n    <div class=\"form-group col-lg-3\">\n       <label for=\"firstname\">First Name</label>\n       <input name=\"contact[first_name]\" type=\"text\" class=\"form-control\" id=\"firstname\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.first_name : stack1), depth0))
	    + "\" required><br/>\n     </div>\n     </div>\n     <div class=\"row\">\n               <div class=\"form-group col-lg-3\">\n    <label for=\"lastname\">Last Name</label>\n	  <input name=\"contact[last_name]\" type=\"text\" class=\"form-control\" id=\"lastname\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.last_name : stack1), depth0))
	    + "\" required><br/>\n  </div>\n  </div>\n  <div class=\"row\">\n            <div class=\"form-group col-lg-3\">\n    <label for=\"email\">Email</label>\n	  <input name=\"contact[email]\" type=\"text\" class=\"form-control\" id=\"email\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.email : stack1), depth0))
	    + "\" required><br/>\n  </div>\n  </div>\n  <div class=\"row\">\n            <div class=\"form-group col-lg-3\">\n    <label for=\"company\">Company</label>\n    <input name=\"contact[company]\" type=\"text\" class=\"form-control\" id=\"company\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.company : stack1), depth0))
	    + "\"><br/>\n  </div>\n  </div>\n  <div class=\"row\">\n            <div class=\"form-group col-lg-3\">\n    <label for=\"position\">Position</label>\n    <input name=\"contact[position]\" type=\"text\" class=\"form-control\" id=\"position\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.position : stack1), depth0))
	    + "\"><br/>\n  </div>\n  </div>\n    <button class=\"btn btn-primary\" id=\"cancel-contact\">Cancel</button><button class=\"btn btn-primary\" id=\"save-contact\">Save</button><button class=\"btn btn-primary\" id=\"delete-contact\">Delete</button>\n</form>\n  <!-- </script> -->";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h3>New Contact:</h1>\n<!-- <script id=\"some-template\" type=\"text/x-handlebars-template\">  -->\n<form id=\"new-contact\" >\n  <div class=\"row\">\n            <div class=\"form-group col-lg-3\">\n    <label for=\"firstname\">First Name</label>\n    <input name=\"contact[first_name]\" type=\"text\" class=\"form-control\" id=\"firstname\" placeholder=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.first_name : stack1), depth0))
	    + "\" required><br/>\n</div>\n</div>\n<div class=\"row\">\n          <div class=\"form-group col-lg-3\">\n    <label for=\"lastname\">Last Name</label>\n	  <input name=\"contact[last_name]\" type=\"text\" class=\"form-control\" id=\"lastname\" placeholder=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.last_name : stack1), depth0))
	    + "\" required><br/>\n  </div>\n  </div>\n  <div class=\"row\">\n            <div class=\"form-group col-lg-3\">\n    <label for=\"email\">Email</label>\n	  <input name=\"contact[email]\" type=\"text\" class=\"form-control\" id=\"email\" placeholder=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.email : stack1), depth0))
	    + "\" required><br/>\n  </div>\n  </div>\n    <div class=\"row\">\n              <div class=\"form-group col-lg-3\">\n    <label for=\"company\">Company</label>\n    <input name=\"contact[company]\" type=\"text\" class=\"form-control\" id=\"company\" placeholder=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.company : stack1), depth0))
	    + "\"><br/>\n  </div>\n  </div>\n    <div class=\"row\">\n              <div class=\"form-group col-lg-3\">\n    <label for=\"position\">Position</label>\n    <input name=\"contact[position]\" type=\"text\" class=\"form-control\" id=\"position\" placeholder=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contact : depth0)) != null ? stack1.position : stack1), depth0))
	    + "\"><br/>\n  </div>\n  </div>\n    <button class=\"btn btn-primary\" id=\"cancel-contact\">Cancel</button><button class=\"btn btn-primary\" id=\"save-contact\">Save</button>\n</form>\n  <!-- </script> -->";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createLogSuccess = function createLogSuccess(data) {
	  $('#content-feedback').text('Log succesfully created');
	  store.logs = data.logs;
	  $('#get-contacts-button').trigger('click');
	};

	var createEmailLog = function createEmailLog(contact) {
	  var logData = { log: { date: new Date().toUTCString(),
	      description: 'Email to ' + contact.email,
	      contact_id: contact['id'] } };
	  api.createLog(logData).then(createLogSuccess).catch(ui.failure);
	};
	...
	var displayLogs = function displayLogs() {
	  api.getLogs().then(getLogsSuccess).catch(ui.failure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createLog = function createLog(logData) {
	  return $.ajax({
	...
	var getLog = function getLog(contactId) {
	  return $.ajax({
	...
	var updateLog = function updateLog(logId, data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showLogsTemplate = __webpack_require__(40);
	...
	var displayLogs = function displayLogs(logs) {
	  store.logs = logs;
	  var showLogsHtml = showLogsTemplate({ logs: logs });
